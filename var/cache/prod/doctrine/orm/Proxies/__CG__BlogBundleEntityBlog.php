...
class Blog extends \BlogBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Blog' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Blog' . "\0" . 'title', '' . "\0" . 'BlogBundle\\Entity\\Blog' . "\0" . 'summary', '' . "\0" . 'BlogBundle\\Entity\\Blog' . "\0" . 'body', '' . "\0" . 'BlogBundle\\Entity\\Blog' . "\0" . 'created'];
        }
